...
Cómo mostrar las cabeceras de petición y respuesta
------------------------------------------------------------------------
...
headers <https://mkyong.com/web/curl-display-request-headers-and-response-headers/>`_
