...
**Tableau** es un software de visualización de datos. Utiliza un
lenguaje visual llamado **VizQL** que permite crear consultas y
visualizar los datos mediante una interfaz de arrastrar y soltar
...
embedding interactive visualizations online to sharing via social media.
