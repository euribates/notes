...
`Chart.js <https://www.chartjs.org/docs/latest/>`__ es una biblioteca
JavaScript gratuita de código abierto para la visualización de datos,
que admite 8 tipos de gráficos:
